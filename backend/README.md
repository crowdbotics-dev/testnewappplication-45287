...
## Project Structure
    ...
    ├── testnewappplication_45287  # Django project configurations
...
1. Clone this repo and `cd testnewappplication_45287`
...
2. Clone this repo and `cd testnewappplication_45287`
